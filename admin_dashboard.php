...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
        <i class="fa-solid fa-right-from-bracket"></i></i> <!-- Profile icon -->
                ...
                <tbody>
                    ...
                    while ($row = $recentBookingsResult->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>" . $row['status'] . "</td>
                                <td>
                                    <a href='?action=approve&booking_id=" . $row['booking_id'] . "' class='btn'>Approve</a>
                                    <a href='?action=reject&booking_id=" . $row['booking_id'] . "' class='btn'>Reject</a>
                                </td>
                            </tr>";
                    }
                    ?>
